...
def get_columns():
    return [
        ...
        {"fieldname": "rounding_adjustment_usd", "label": _("Movimiento de conciliación US$"), "fieldtype": "Currency", "options": "USD", "width": 170},
        {"fieldname": "employee_pending_usd", "label": _("Pendiente trabajador US$"), "fieldtype": "Currency", "options": "USD", "width": 145},
        {"fieldname": "pending_core_usd", "label": _("Pendiente core US$"), "fieldtype": "Currency", "options": "USD", "width": 125},
        ...
        {"fieldname": "employee_pending_nio", "label": _("Pendiente trabajador C$"), "fieldtype": "Currency", "options": "NIO", "width": 145},
        {"fieldname": "pending_core_nio", "label": _("Pendiente core C$"), "fieldtype": "Currency", "options": "NIO", "width": 125},
